    ...
    <div className="w-[250px] border h-screen bg-slate-100">
      ...
      <div className="mt-8">
        <ul className="flex flex-col gap-6 pl-6">
          <li className="text-md font-nunito flex items-center gap-1 cursor-pointer">
            <MdDashboard /> Dashboard
          </li>
          <li className="text-md font-nunito flex items-center gap-1 cursor-pointer">
            <PiStudentBold /> Admission
          </li>
          <li className="text-md font-nunito flex items-center gap-1">
            <MdManageAccounts />
            Student Management
          </li>
          <li className="text-md font-nunito flex items-center gap-1">
            <BiAnalyse /> Resport and Analysis
          </li>
        </ul>
      </div>
    </div>
