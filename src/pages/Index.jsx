    ...
    <div className=" flex">
      ...
      <div className="basis-3/5 px-4  flex flex-col gap-3 py-32">
        ...
        <p className="text-md font-nunito text-slate-600">
          ...
          fugit dolorem dolorum aliquid impedit ea quibusdam sunt laborum facere
          unde consequuntur dolores quae assumenda repellendus rem similique
          recusandae reiciendis quia architecto vel iure tenetur dicta. Natus
          atque ipsam veritatis.
        </p>
